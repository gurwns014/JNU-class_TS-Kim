...
if __name__ == "__main__":
    ...
    FIXED_CONDITIONS["cold_inlet"]["m_dot"] = 0.20
    ...
    fig.savefig("pressure_drop.png", dpi=130, bbox_inches="tight")

    print(f"\n  Total Hot dP  = {dP_h[-1]/1000:.3f} kPa")
    print(f"  Total Cold dP = {dP_c[-1]/1000:.3f} kPa")
