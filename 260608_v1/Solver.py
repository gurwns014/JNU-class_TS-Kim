...
def cell_solve_q(hp, cp, hot_state, cold_state,
    ...
    if dryout_active:
        ...
        q_pd = U_pd * dT
        T_wh_pd, T_wc_pd, T_wall_pd = estimate_T_wall(
            T_hot, T_cold, h_hot_sp["h"], h_pd, q_pd)
        return dict(
    ...
    for it in range(1, max_it + 1):
        ...
        T_wh_iter, T_wc_iter, T_wall_avg = estimate_T_wall(
